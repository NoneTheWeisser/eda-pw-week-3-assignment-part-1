...
let favoriteFoods = [`tacos`, `pasta`, `pizza`, `burgers`, `nachos`, `cheesesteaks`];
...
let dessert = `ice cream sandwich`;
favoriteFoods.push(dessert);
console.log(`Added favorite dessert`, dessert);
console.log (favoriteFoods);
// One way to check is in the console by typing in favoriteFoods
...
console.log (`Added favorite entree to the beginning:, ${entree}`);
console.log (favoriteFoods);
...
console.log (`removed last color from array:`, lastColor);
...
colors.shift();
console.log(`remove first color`, colors);
...
gems.sort();
gems.reverse();
console.log (`Reversed order of gems:`, gems );
